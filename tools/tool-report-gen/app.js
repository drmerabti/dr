...
{ id: 'tool-report-gen', title_ar: 'مولّد تقرير مهني', title_en: 'Professional Report Generator',
  desc_ar: 'أنشئ تقارير عمل احترافية بقوالب جاهزة (عام، حادثة، أداء دوري، محضر اجتماع)، فهرس تلقائي، وتصدير PDF متعدد الصفحات، ومكتبة تقارير محفوظة — يتطلب تسجيل الدخول.',
  desc_en: 'Generate professional work reports from ready templates (general, incident, periodic performance, meeting minutes), with auto table of contents, multi-page PDF export, and a saved reports library — requires login.',
